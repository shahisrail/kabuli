  ...
  return (
    <div className="text-black">
      ...
      <h3 className="text-center text-2xl font-bold mt-5">
        The Journey of Farhad: <br /> From Kabul to Birmingham
      </h3>
      ...
      <div className="flex justify-center items-center mt-5">
        <img src="/assets/ourSoty.jpg" alt="our Story" />
      </div>
      <p className="text-left text-[15px] mt-5 max-w-2xl mx-auto">
      ...
      <h2 className="text-center text-2xl font-bold mt-5">And so, Kabuli was born.</h2>
      <p className="text-left text-[15px] mt-5 max-w-2xl mx-auto">
      ...
      <div className="flex justify-center items-center mt-5">
        <img className="w-full" src="/assets/ourstoryimage.jpg" alt="" />
      </div>
    </div>
  );
};
