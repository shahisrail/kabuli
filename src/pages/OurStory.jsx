...
const OurStory = () => {
  return (
    <div className=" py-8">
      ...
      <p className="text-left text-sm mt-5 max-w-2xl mx-auto px-4 md:text-sm">
      ...
      <p className="text-left text-sm mt-5 max-w-2xl mx-auto px-4  ">
      ...
      <div className="  mt-8 py-2 p-2 mb-4 text-sm   max-w-md mx-auto text-left md:max-w-2xl  md:p-3 md:py-3 md:mb-5">
        <p>
